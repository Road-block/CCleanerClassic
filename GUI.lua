...
-- Main Frame
------------------
addon.GUI = CreateFrame("Frame", addonName.."GUI", UIParent, "BasicFrameTemplate")
addon.GUI:SetSize(675, 500)
addon.GUI:SetPoint("CENTER")
addon.GUI:SetClampedToScreen(true)
addon.GUI:EnableMouse(true)
addon.GUI:SetMovable(true)
addon.GUI:RegisterForDrag("LeftButton")
addon.GUI:SetScript("OnDragStart", function(self) self:StartMoving() end)
addon.GUI:SetScript("OnDragStop",  function(self) self:StopMovingOrSizing() end)
addon.GUI:Hide()

------------------
-- Title
------------------
addon.GUI.title = addon.GUI:CreateFontString(nil, nil, "GameFontNormalMed2")
addon.GUI.title:SetPoint("TOPLEFT", 15, -5)
addon.GUI.title:SetText("ChatCleanerClassic " .. string.format("v%s", addon.GetAddOnMetadata(addonName, "Version")))

------------------
-- Slash Command
------------------
SlashCmdList["ChatCleanerClassic"] = function() addon.GUI:Show() end
...
-- General Options
------------------
local cccTxtGeneral = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
cccTxtGeneral:SetPoint("TOPLEFT", addon.GUI.title, "BOTTOMLEFT", 0, -20)
cccTxtGeneral:SetText("General Options:")

------------------
-- Enabled
------------------
local cccChkEnabled = CreateFrame("CheckButton", nil, addon.GUI, "OptionsBaseCheckButtonTemplate")
...
local cccTxtEnabled = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Filter Friendly
------------------
local cccChkFilterFriendly = CreateFrame("CheckButton", nil, addon.GUI, "OptionsBaseCheckButtonTemplate")
...
local cccTxtFilterFriendly = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Whole Words
------------------
local cccChkWoleWords = CreateFrame("CheckButton", nil, addon.GUI, "OptionsBaseCheckButtonTemplate")
...
local cccTxtWholeWords = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Highlight Color
------------------
local cccInputHColor = CreateFrame("EditBox", nil, addon.GUI, "InputBoxTemplate")
...
------------------
local cccTextHColor = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Channels
------------------
local cccInputChan = CreateFrame("EditBox", nil, addon.GUI, "InputBoxTemplate")
...
------------------
local cccTextChan = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Filter Say Chat
------------------
local cccChkFilterSay = CreateFrame("CheckButton", nil, addon.GUI, "OptionsBaseCheckButtonTemplate")
...
local cccTxtFilterSay = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
-- Filter Yell Chat
------------------
local cccChkFilterYell = CreateFrame("CheckButton", nil, addon.GUI, "OptionsBaseCheckButtonTemplate")
...
local cccTxtFilterYell = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
------------------
local cccBtnExport = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
cccBtnExport:SetHeight(25)
cccBtnExport:SetWidth(325)
cccBtnExport:SetPoint("TOP",  addon.GUI, "BOTTOM", 0, 30)
...
------------------
local cccBtnImport = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
cccBtnImport:SetHeight(25)
cccBtnImport:SetWidth(325)
cccBtnImport:SetPoint("TOP",  addon.GUI, "BOTTOM", 0, 30)
...
-- Required Keywords
------------------
local cccTxtReqBtn = CreateFrame("Button", nil, addon.GUI, "UIPanelInfoButton")
cccTxtReqBtn:SetPoint("TOP",  cccTextChan, "BOTTOM", 0, -15)
cccTxtReqBtn:SetPoint("LEFT", cccTextChan, "LEFT", 3, 0)
local cccTxtReq = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
cccTxtReq:SetPoint("TOPLEFT", cccTxtReqBtn, "TOPRIGHT", 5, 0)
cccTxtReq:SetText("Required keywords:")
------------------
local cccBtnReqRevert = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
...
------------------
local cccBtnReqSave = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
...
-- Clean Keywords
------------------
local cccTxtCleanBtn = CreateFrame("Button", nil, addon.GUI, "UIPanelInfoButton")
cccTxtCleanBtn:SetPoint("TOP",  cccTextChan, "BOTTOM", 0, -15)
cccTxtCleanBtn:SetPoint("LEFT", cccBtnImport, "LEFT", 8, 0)
local cccTxtClean = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
cccTxtClean:SetPoint("TOPLEFT", cccTxtCleanBtn, "TOPRIGHT", 5, 0)
cccTxtClean:SetText("Clean keywords:")
------------------
local cccBtnCleanRevert = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
...
------------------
local cccBtnCleanSave = CreateFrame("Button", nil, addon.GUI, "UIPanelButtonTemplate")
...
------------------
local cccTxtIEStatus = addon.GUI:CreateFontString(nil, nil, "GameFontHighlight")
...
cccTxtIEStatus:SetWidth(addon.GUI:GetWidth() - 30)
...
-- Required Table
------------------
local cccEditReq = CreateFrame("EditBox", nil, addon.GUI)
...
cccEditReq:Show()
------------------
local cccScrollReq = CreateFrame("ScrollFrame", nil, addon.GUI, "UIPanelScrollFrameTemplate")
...
------------------
local cccBGFReq = CreateFrame("Frame", nil, addon.GUI, BackdropTemplateMixin and "BackdropTemplate");
...
-- Clean Table
------------------
local cccEditClean = CreateFrame("EditBox", nil, addon.GUI)
...
cccEditClean:Show()
------------------
local cccScrollClean = CreateFrame("ScrollFrame", nil, addon.GUI, "UIPanelScrollFrameTemplate")
...
------------------
local cccBGFClean = CreateFrame("Frame", nil, addon.GUI, BackdropTemplateMixin and "BackdropTemplate")
...
------------------
addon.GUI:SetScript("OnShow",  function() LoadSettings() end)
